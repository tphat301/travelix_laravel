@extends('admin.index')
@section('title' , "Cập nhật nhận xét")
...
<div class="container-fluid pt-4 px-4">
    ...
    @endif
    {!! Form::open(['url' => ['admin/criteria/store/'.$criteriaById->id], 'class' => ['card__form'], 'files' => true]) !!}
        @csrf
        <div class="row g-4">
            <div class="col-sm-12 col-xl-6">
                <div class="bg-secondary rounded h-100 p-4">
                    <h6 class="mb-4">Cập nhật nhận xét</h6>
                    <div class="mb-3">
                        {!! Form::label('slug', 'Tên đường dẫn:', ['class'=>['card__label--slug','col-sm-4', 'col-form-label']]); !!}
                        {!! Form::text('slug', $criteriaById->slug, ['class'=>['card__slug', 'slug__type', 'form-control'] ,'placeholder'=>'Tên đường dẫn']) !!}
                        @error('slug')
                    ...
                    <div class="mb-3">
                        ...
                        {!! Form::text('name', $criteriaById->name, ['class'=>['card__name', 'name__type', 'form-control'] ,'placeholder'=>'Tiêu đề']) !!}
                        @error('name')
                            <small class="text-red-700">{{ $message }}</small>
                        @enderror
                    </div>
                    <div class="mb-3">
                        ...
                        {!! Form::textarea('desc', $criteriaById->desc, ['class' => ['medium_text','card__desc'], 'placeholder' => 'Mô tả sản phẩm']) !!}
                    </div>
            ...
            <div class="col-sm-12 col-xl-6 bg-secondary">
                <div class="mb-3">
                    ...
                    @if ($criteriaById->photo)
                        <img src="{{ asset('public/backend/uploads/'.$criteriaById->photo) }}" class="card__img card__img--dev">
                    @else
                ...
                <div class="mb-3">
                    ...
                    @if ($criteriaById->photo1)
                        <img src="{{ asset('public/backend/uploads/'.$criteriaById->photo1) }}" class="card__img card__img--dev">
                    @else
                        <img src="{{ asset('public/backend/img/img_error.png') }}" class="card__img card__img--dev">
                    @endif
