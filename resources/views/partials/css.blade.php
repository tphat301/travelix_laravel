<link rel="stylesheet" type="text/css" href="{{ url('public/frontend/css/bootstrap4/bootstrap.min.css') }}">
<link href="{{ url('public/frontend/plugins/font-awesome-4.7.0/css/font-awesome.min.css') }}" rel="stylesheet" type="text/css">
