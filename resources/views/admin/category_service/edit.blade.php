...
<div class="container-fluid pt-4 px-4">
    ...
    @endif
    {!! Form::open(['url' => ['admin/category_service/store/'.$categoryServiceLevel1->id], 'class' => ['card__form'], 'files' => true]) !!}
        @csrf
        <div class="row g-4">
            <div class="col-sm-12 col-xl-6">
                <div class="bg-secondary rounded h-100 p-4">
                    ...
                    <div class="mb-3">
                        ...
                        {!! Form::text('slug', $categoryServiceLevel1->slug, ['class'=>['card__slug', 'slug__type', 'form-control'] ,'placeholder'=>'Tên đường dẫn']) !!}
                        @error('slug')
                    ...
                    <div class="mb-3">
                        ...
                        {!! Form::text('name', $categoryServiceLevel1->name, ['class'=>['card__name', 'name__type', 'form-control'] ,'placeholder'=>'Tên dịch vụ']) !!}
                        @error('name')
                            <small class="text-red-700">{{ $message }}</small>
                        @enderror
                    </div>
                    <div class="mb-3">
                        ...
                        {!! Form::text('brand', $categoryServiceLevel1->brand, ['class'=>['card__brand', 'brand__type', 'form-control'] ,'placeholder'=>'Tên thương hiệu']) !!}
                        @error('brand')
                            <small class="text-red-700">{{ $message }}</small>
                        @enderror
                    </div>
                    ...
                    {{-- <div class="mb-3">
                        ...
                        {!! Form::textarea('desc', $categoryServiceLevel1->desc, ['class' => ['medium_text','card__desc'], 'placeholder' => 'Mô tả sản phẩm']) !!}
                    </div>
                    <div class="mb-3">
                        {!! Form::label('content', 'Nội dung:', ['class'=>['card__label--content','col-sm-4', 'col-form-label']]); !!}
                        {!! Form::textarea('content', $categoryServiceLevel1->content, ['class' => ['medium_text','card__content'], 'placeholder' => 'Nội dung sản phẩm']) !!}
                    </div> --}}
            ...
            <div class="col-sm-12 col-xl-6 bg-secondary">
                <div class="mb-3">
                    ...
                    @if ($categoryServiceLevel1->photo)
                        <img src="{{ asset('public/backend/uploads/'.$categoryServiceLevel1->photo) }}" class="card__img card__img--dev">
                    @else
                ...
                {{-- <div class="mb-3">
                    ...
                    @if ($categoryServiceLevel1->photo1)
                        <img src="{{ asset('public/backend/uploads/'.$categoryServiceLevel1->photo1) }}" class="card__img1 card__img--dev">
                    @else
                ...
                <div class="mb-3">
                    ...
                    @if ($categoryServiceLevel1->photo2)
                        <img src="{{ asset('public/backend/uploads/'.$categoryServiceLevel1->photo2) }}" class="card__img2 card__img--dev">
                    @else
