@extends('admin.index')
@section('title' , "Thêm danh mục dịch vụ cấp 2")
...
<div class="container-fluid pt-4 px-4">
    ...
    @endif
    {!! Form::open(['url' => ['admin/category_service2/store'.'/'], 'class' => ['card__form'], 'files' => true]) !!}
        @csrf
        <div class="row g-4">
            <div class="col-sm-12 col-xl-6">
                <div class="bg-secondary rounded h-100 p-4">
                    <h6 class="mb-4">Thêm danh mục {{ __('Service') }} cấp 2</h6>
                    <div class="mb-3">
