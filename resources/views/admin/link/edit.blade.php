...
<div class="container-fluid pt-4 px-4">
    ...
    @endif
    {!! Form::open(['url' => ['admin/link/store/'.$linkById->id], 'class' => ['card__form'], 'files' => true]) !!}
        @csrf
        <div class="row g-4">
            <div class="col-sm-12 col-xl-12">
                <div class="bg-secondary rounded h-100 p-4">
                    <h6 class="mb-4">Cập nhật link</h6>
                    <div class="mb-3">
                        {!! Form::label('link', 'Link:', ['class'=>['card__label--name','col-sm-4', 'col-form-label']]); !!}
                        {!! Form::text('link', $linkById->name, ['class'=>['card__name', '', 'form-control'] ,'placeholder'=>'Link']) !!}
                        @error('link')
