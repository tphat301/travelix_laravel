...
<div class="container-fluid pt-4 px-4">
    ...
    @endif
    {!! Form::open(['url' => ['admin/slogan/store'.'/'], 'class' => ['card__form'], 'files' => true]) !!}
        @csrf
        <div class="row g-4">
            <div class="col-sm-12 col-xl-12">
                <div class="bg-secondary rounded h-100 p-4">
                    <h6 class="mb-4">Thêm slogan</h6>
                    ...
                    <div class="mb-3">
                        ...
                        {!! Form::text('slogan', '', ['class'=>['card__name', 'name__type', 'form-control'] ,'placeholder'=>'Tiêu đề']) !!}
                        @error('slogan')
                            <small class="text-red-700">{{ $message }}</small>
                        @enderror
                    </div>
